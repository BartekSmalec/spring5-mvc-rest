...
public class CustomerController {
    ...
    @ApiOperation(value = "This will get a list of custoemrs", notes = "This is example of note")
    @GetMapping
    ...
    public CustomerDTO createNewCustoemr(@RequestBody CustomerDTO customerDTO) {
